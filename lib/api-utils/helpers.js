...
async function buildInvoiceBuffer(order) {
  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      doc.fillColor('#E30613').fontSize(26).text('CKS MOTORS', 40, 40)
      ...
      // Footer
      doc.fontSize(8).fillColor('#aaaaaa').text('CKS Motors - Accra, Ghana | cksmotors.com', 40, 780, { align: 'center' })
